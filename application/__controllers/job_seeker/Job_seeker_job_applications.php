    ...
    function save_job_application()
    {
        try {
           ...
           // $job_application = $this->input->post();
             ...
             $job_application['job_post_id'] = $this->input->post('job_post_id');
             $job_application['applied_resume'] = $this->input->post('applied_resume');
             $job_application['applied_cover_letter'] = $this->input->post('applied_cover_letter');
             $job_application['cover_letter_content'] = $this->input->post('cover_letter_content');
             $job_application['jobseeker_id'] = $_SESSION['user_id'];
             $job_application['skills'] = $this->input->post('skills');
             
            // $job_application[] = $this->input->post();

           // array_splice($job_application, $this->input->post('quz'));
