                                                        ...
                                                        <div class="pf-field">
                                                            <select name="jobseeker_country_id" class="chosen" id="county-selector">
                                                                <option value="" >Please select your country</option>
                                                                 <option value="203" selected>Oman</option>
                                                                <?php
                                                                /*
                                                                if (isset($country_list_iso)) {
                                                                    if (!empty($country_list_iso)) {
...
<!--                                            <div class="border-title"><h3>My Resume--><?php //echo !empty($resume_data['resume_name']) ? ': '.$resume_data['resume_name'] : ''?><!--</h3></div>-->
 ...
 <div class="border-title"><h6>Add Video</h6></div>
  <div class="edu-history-sec resume-sec" id="jobseeker_video">
    <form enctype="multipart/form-data" id="vform">

    <!--  -->
<input id="file-input" type="file" accept="video/*" style="visibility: visible;    visibility: visible;
    width: 227px  !important;height:55px !important" name="file" >
...
$sql2 ="SELECT * FROM `jobseeker_video` where jobseeker_id='$user_id'  order by  id desc   limit 1  ";
...
$(':file').on('change', function () {
  ...
  $.ajax({
    ...
    url: '/job_seeker/job_seeker_resume/add_resume_video?&white_rice_token=' + rice,
    type: 'POST',
  ...
  // Also see .name, .type
                                                ...
                                                <div class="edu-history-sec resume-sec" id="lang-skill-sec">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <?php //echo var_dump($resume_data) ?>
                                                        <?php if (isset($resume_data)) {
                                                            $jobseeker_user_id= $resume_data['jobseeker_user_id'];
                                                             $sql ="SELECT `jobseeker_resume`.* FROM `jobseeker_resume` WHERE `jobseeker_user_id` IN($jobseeker_user_id) and resume_attachment is not null";
                                                           ...
                                                           // echo  var_dump($result);
                                                            ...
                                                            foreach ($result as $resume_data_single) {
                                                                # code...
                                                                    ...
                                                                    <div class="row">
                                                                        <div class=" col-10">
                                                                            <p class="mb-0" style=" font-size: 12px;">
                                                                                File Name : <?php echo !empty($resume_data_single->resume_attachment) ? $resume_data_single->resume_attachment : ''  ?>
                                                                            </p>

                                                                        </div>
                                                                        <div class="col-2">
                                                            <span class="col-2 float-left">
                                                                <?php if (!empty($resume_data_single->resume_attachment)) {
                                                                    $file = pathinfo(JOB_SEEKER_RESUME_READ_DIR.$resume_data_single->resume_attachment, PATHINFO_EXTENSION);
                                                                    if ($file === "pdf") {
                                                                        ?>
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="mt-2 pr-2 w-100">
                                                                            <a class="btn btn-success float-right m-2 col-3" href= "<?php echo !empty($resume_data_single->resume_attachment) ? JOB_SEEKER_RESUME_READ_DIR.$resume_data_single->resume_attachment : '' ?>" target="_blank">View</a>
                                                                            <a class="btn btn-danger float-right m-2 col-2 del-res-file" id="btn-del-res-file" data-r-id="<?php echo !empty($resume_data_single->resume_id) ? $resume_data_single->resume_id : ''?>">
                                                                                <i class="la la-trash-o" data-r-id="<?php echo !empty($resume_data_single->resume_id) ? $resume_data_single->resume_id : ''?>"></i>
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                                                </div>
