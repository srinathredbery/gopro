            ...
            <div class="row no-gape">
                ...
                <div class="col-lg-6 column job-sec printHtml">
                    <div class="padding-left">
                        <a href="<?php echo base_url()?>employer/job_posts/ats_Interviewee" id="back_btn">
                            <label>
...
<!--                            <div class="col-md-12">-->
                            <a type="button" onclick="view_profile(<?php echo $this->input->get('emp_id'); ?>)"  class="btn btn-primary col-md-5"><span class="la la-id-card"></span>&nbsp;Profile</a>&nbsp;
<!--                            </div>-->
<!--                            <div class="col-md-12">-->
                            &nbsp;
                          <?php  //echo var_dump($data); ?>
                            <a type="button" href="../../employer/resume/view?r_id=<?php echo $resume_id; ?>" target="_blank"  class="btn btn-success col-md-5"><span class="la la-paperclip"></span>&nbsp;Resume</a>&nbsp;
<!--                            </div>-->
...
<!--                            </div>-->
                            <div class="col-md-12 row">
                                ...
                                <?php //echo var_dump();?>
                                <div class="col-md-6"><input id="exam" type="text" id="exam_v" value="<?php echo $marks[0]['avg']; ?>%" class="form-control" disabled/></div>
                            </div>
                            <div class="col-md-12 row">
                            ...
                            <div class="col-md-12 row" style="margin-top: 80px;">
                                <select class="form-control dropdown_f" id="status">
                                    ...
                                    <option>Selected to 1st round</option>
                                    <option>Selected to 2nd round</option>
                                    <option>Selected to 3rd round</option>
            ...
            <div class="modal-body profile-modal">
                ...
                <div>
                    ...
                    <div class="col-md-12 row">
                        ...
                        <div class="col-lg-7">
                            <label class="la la-facebook pr-lg-3"></label><a id="fb">facebook</a>
                            <label class="la la-twitter pr-lg-3"></label><a id="twitter">Twitter</a>
                            <label class="la la-linkedin pr-lg-3"></label><a id="linkedin">Linkedin</a>
                            <label class="la la-youtube pr-lg-3"></label><a id="youtube">youtube </a>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    window.onload = function () {
        // var ats_v=75;//$('#ats_v').val();
        var exam_v=<?php echo $marks[0]['avg']; ?>;
        //$('#exam_v').val();
        ...
        var chart = new CanvasJS.Chart("chartContainer", {
            ...
            data: [{
                ...
                legendText: "Avg = Average exam marks",
                dataPoints: [
...
<script>
                ...
                for(var i=0;i<data.output.length;i++) {
                    ...
                    if (i == 0) {
                       ...
                       // $("#uploaded_image_view").attr("src",data.output[i]['jobseeker_dp_url']);
                         $("#uploaded_image_view").attr("src",'http://rbjobs.rbdemo.live/assets/styles/images/defaults/pro_pic.png');
  // if( data.output[i]['jobseeker_dp_url']==''){
  //                            $("#uploaded_image_view").attr("src",'http://rbjobs.rbdemo.live/assets/styles/images/defaults/pro_pic.png');
  //                       }
  //                      else{
  //                        $("#uploaded_image_view").attr("src",data.output[i]['jobseeker_dp_url']);
  //                      }
    ...
    function saved_data(){
     ...
     var id_shadule='<?php echo $_GET['id_shadule'] ?>';
