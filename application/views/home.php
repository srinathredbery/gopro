                ...
                <div class="col-lg-12">
                    <div class="main-featured-sec">
                        <ul class="main-slider-sec text-arrows">
                            <li class="slideHome">
                                <img src="<?php echo base_url() ?>assets/styles/images/rb_jobs/slider (2).jpg" alt=""/>
                            </li>
                            <li class="slideHome">
                                <img src="<?php echo base_url() ?>assets/styles/images/rb_jobs/slider (3).jpg" alt=""/>
                            </li>
                            <li class="slideHome">
                                <img src="<?php echo base_url() ?>assets/styles/images/rb_jobs/slider (1).jpg" alt=""/>
                            </li>
            ...
            <div class="row">
                    ...
                    <div class="float-right ml-3 ml-md-5">
                        ...
                        <div class="stats-sec style2  text-left">
                            ...
                            <div class="widget mb-4">
                                <a href="#" title="">
                                    <img class="app-badge-mid-section" src="<?php echo base_url() . 'assets/styles/images/google-play-badge.png' ?>" alt=""/>
                                </a>
                                <a href="#" title="">
                                    <img class="app-badge-mid-section" src="<?php echo base_url() . 'assets/styles/images/app-store-badge.png' ?>" alt=""/>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
                    <div class="home-mobile-banner">
                        <img src="<?php echo base_url()?>assets/styles/images/rb_jobs/mobile_banner.png" alt="" width="300"/>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <?php if (isset($ads_footer) && empty($ads_footer)) {
                    ...
                    <div class="col-lg-6 padR0 padL0 column bg-1">
                        <div class="pbs-intl">
                            <h3>RbJobs</h3>
                            <p>RbJobs is powered by a team of recruiting industry experts, outstanding engineers,
