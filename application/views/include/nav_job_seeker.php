...
<!--					<img class="cus-logo img-fluid" src="--><?php //echo base_url() ?><!--assets/styles/images/OMRAN_logo.png" alt=""/>-->
					<img class="cus-logo img-fluid" src="<?php echo base_url() ?>assets/styles/images/rb_jobs/logo-dark2.png" alt=""/>
...
<!--						<img class="cus-logo img-fluid" src="--><?php //echo base_url()?><!--assets/styles/images/OMRAN_logo.png" alt=""/>-->
						<img class="cus-logo img-fluid" src="<?php echo base_url()?>assets/styles/images/rb_jobs/logo_dark2.png" alt=""/>
					</a><span class="beta-tag"></span>
                </div><!-- Logo -->
