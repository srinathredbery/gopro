...
<div class="theme-layout" id="scrollup">
    ...
    <div class="responsive-header">
        <div class="responsive-menubar">
            <div class="res-logo cus-logo img-fluid"><a href="<?php echo base_url() ?>" title="">
            <img src="<?php echo base_url() ?>assets/styles/images/OMRAN_logo.png" alt=""/>
            <!--        <img src="<?php //echo base_url() ?>assets/styles/images/rb_jobs/logo-white2.png" alt=""/> -->
                            ...
                            if (isset($element['parent_id'])) {
                                if ($element['parent_id'] == 0) {
                                    ...
                                    <li class="<?php echo $show_navigation_sub_menu_icon ?>">
                                        <a <?php echo isset($element['url']) ? 'href="' . base_url() . $element['url'] . '"' : '' ?>>
                                                ...
                                                foreach ($navigation_top_menu_main as $sub_menu) {
                                                    if ($sub_menu['parent_id'] == $element['id']) {
                                                        ...
                                                        <li class="signin-popup">
                                                            <a <?php echo isset($sub_menu['url']) ? 'href="' . base_url() . $sub_menu['url'] . '"' : '' ?>>
            ...
            <div class="container">
                <div class="logo">
                    <a href="<?php echo base_url() ?>" title="">
                     <img class="hidesticky cus-logo-sticky img-fluid" src="<?php echo base_url() ?>assets/styles/images/logo_wite_new.png" alt=""/>
             <img class="showsticky cus-logo-sticky img-fluid" src="<?php echo base_url() ?>assets/styles/images/OMRAN_logo.png" alt=""/>

                  <!--       <img class="hidesticky cus-logo-sticky img-fluid" src="<?php //echo base_url() ?>assets/styles/images/rb_jobs/logo-white2.png" alt=""/>
                        <img class="showsticky cus-logo-sticky img-fluid" src="<?php //echo base_url() ?>assets/styles/images/rb_jobs/logo-dark2.png" alt=""/> -->
                    </a><span class="beta-tag"></span>
                </div><!-- Logo -->
                <div class="btn-extars">
                                            ...
                                            if ($show_panel) {
                                                ...
                                                <ul>
                                                    ...
                                                    foreach ($navigation_top_menu_main as $sub_menu) {
                                                        if ($sub_menu['parent_id'] == $element['id']) {
                                                            ?>
                                                            <li class="<?php echo !empty($sub_menu['page_title']) && $sub_menu['page_title']=='Login' ? 'signin-popup' : ''?>">
                                                                <a <?php echo !empty($sub_menu['url']) ? 'href="' . base_url() . $sub_menu['url'] . '"' : '' ?>>
                                                                    <?php echo $sub_menu['page_title'] ?>
                                                                </a>
                                                            </li>
                                                            <?php
