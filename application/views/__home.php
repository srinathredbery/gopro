                    ...
                    <div class="main-featured-sec">
                        <ul class="main-slider-sec text-arrows">
                            <li class="slideHome"><img
                                        src="<?php echo base_url() ?>assets/styles/images/resource/slider-img (5).jpg" alt=""/>
                            </li>
                            <li class="slideHome"><img
                                        src="<?php echo base_url() ?>assets/styles/images/resource/slider-img (4).jpg"
                                        alt=""/></li>
                            <li class="slideHome"><img
                                        src="<?php echo base_url() ?>assets/styles/images/resource/slider-img (6).jpg"
                                        alt=""/></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
                    <div class="home-mobile-banner">
                        <img src="<?php echo base_url()?>assets/styles/images/mobile_banner2.png" alt="" width="300"/>
                    </div>
            ...
            <div class="row">
                ...
                <?php if (isset($ads_footer) && empty($ads_footer)) {
                    ...
                    <div class="col-lg-6 padR0 padL0 column bg-1">
                        <div class="pbs-intl">
                            <h3>OMRAN</h3>
                            <p>OMRAN is powered by a team of recruiting industry experts, outstanding engineers,
