    ...
    <div class="responsive-header">
        <div class="responsive-menubar">
            <div class="res-logo cus-logo img-fluid"><a href="<?php echo base_url() ?>" title="">
                <img src="<?php echo base_url()?>assets/styles/images/OMRAN_logo.png" alt=""/></a>
                    <!-- <img src="<?php //echo base_url()?>assets/styles/images/rb_jobs/logo-white2.png" alt=""/></a> -->
            ...
            <div class="container">
                <div class="logo">
                 ...
                 <img class="hidesticky cus-logo-sticky img-fluid" src="<?php echo base_url()?>assets/styles/images/OMRAN_logo.png" alt=""/>
                   <img class="showsticky cus-logo-sticky img-fluid" src="<?php echo base_url()?>assets/styles/images/OMRAN_logo.png" alt=""/></a>
                   <!--  <img class="hidesticky cus-logo-sticky img-fluid" src="<?php echo base_url()?>assets/styles/images/rb_jobs/logo-white2.png" alt=""/>
                        <img class="showsticky cus-logo-sticky img-fluid" src="<?php echo base_url()?>assets/styles/images/rb_jobs/logo-white2.png" alt=""/></a> -->
                    <span class="beta-tag"></span>
                </div><!-- Logo -->
                <div class="btn-extars">
                    <?php
