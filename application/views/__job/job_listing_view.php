    ...
    <div class="block no-padding">
        <div class="container">
            <div class="row no-gape select2-custom-style">
                <aside class="col-lg-4 column border-right pt-3">
                    <div class="widget">
                        <div class="search_widget_job">
                            ...
                            <!-- Search Widget -->
                            <div class="">
                                <select id="country_filter" class="select2-custom" data-placeholder="Oman Governorates">
                                    <option value=""></option>
                                    <?php
                        ...
                        <div class="range_slider" style="display: block;">
                            ...
                            <div class="salary-filter-currency-range-slider">
                                <div class="nstSlider salary-Filter" data-range_min="0"
                                     data-range_max="<?php
                                        if (!empty($max_salary['max_sal_usd']) && isset($_GET['cur'])) {
                                            echo round(($max_salary['max_sal_usd'] * get_exchange_rate('USD', $_GET['cur']))/500)*500;
                                        } else {
                                            echo round($max_salary['max_sal_usd'], -1);
                                        }
                                     ...
                                     data-cur_min="0"
                                     data-cur_max="<?php
                                        if (isset($_GET['mx_sal']) && !empty(($_GET['mx_sal']))) {
                                            echo $_GET['mx_sal'];
                                        } elseif (!empty($max_salary['max_sal_usd'])) {
                                            echo round($max_salary['max_sal_usd'], -3);
                                        }
                                        ?>">
                        ...
                        <div class="range_slider" style="display: block;">
                            <div class="salary-filter-currency-range-slider">
                                <div class="nstSlider exp-Filter"
                                     data-range_min="0"
                                     data-range_max="<?php
                                        if (!empty($max_experience['max_exp'])) {
                                            echo $max_experience['max_exp'];
                                        } else {
                                            echo $max_experience['max_exp'];
                                        }
                                        ?>"
                                     data-cur_min="<?php
                                        if (isset($_GET['mi_exp'])) {
                                            echo $_GET['mi_exp'];
                                        } else {
                                            echo "0";
                                        };
                                        ?>"
                                     data-cur_max="<?php
                                        if (isset($_GET['mx_exp'])) {
                                            echo $_GET['mx_exp'];
                                        } elseif (!empty($max_experience['max_exp'])) {
                                            echo $max_experience['max_exp'];
                                        }
                                        ?>">
                                    <div class="bar nst-animating" style="left: 0px; width: 226px;"></div>
                        ...
                        <div class="subscribe_widget">
                            ...
                            <form id="contact_details_form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="pf-field">
                                            <input type="submit" id="btnSubmit" value="Send" class="btn btn-orange text-white"  style="background-color: #59a3fc !important; ">
                                        </div>
                                    </div>
                ...
                <div class="col-lg-8 column p-2">
                    <div class="job-heading-sec">
                        <div class="modrn-joblist border-0">
                            <!--                        <div class="tags-bar">-->
