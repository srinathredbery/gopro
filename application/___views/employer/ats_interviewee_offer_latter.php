                                    ...
                                    if (isset($active_job_posts) && !empty($active_job_posts)) {
                                        ...
                                        foreach ($active_job_posts as $active_post) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="status">
                                                        <a class="la la-pencil text-info fa-2x" href="<?php echo base_url() . "employer/job_posts/ats_interviewee_offer_latter_maker?id=" . $active_post['id_offer_latter'] ?>"></a>&nbsp;
                                                    </span>
                                                    <span class="status">
                                                        <a class="la la-trash  text-danger fa-2x" onclick="delete_form(<?php echo $active_post['id_offer_latter'] ?>)"></a>&nbsp;
                                                    </span>
                                                </td>
                                            </tr>
                                            <?php
...
<script>
    ...
    function OpenPapaerMaker() {
        ...
        window.location.href = "<?php echo base_url() ?>employer/job_posts/ats_interviewee_offer_latter_maker"
    ...
    function delete_form(id){
        $.ajax({
            ...
            dataType: 'json',
            url: base_url + 'employer/job_posts/ats_delete_interviewer_offer_latter',
            cache: true,
            beforeSend: function() {
                HoldOn.open(loader_options);
            },
        ...
        Swal.fire(
                'Delete!',
                'successfully deleted offer letter',
                'success'
        )
