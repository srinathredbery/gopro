            ...
            <div class="row no-gape">
                ...
                <div class="col-lg-6 column job-sec">
                    <div class="padding-left">
                        <a href="<?php echo base_url()?>employer/job_posts/ats_interviewee_offer_latter">
<!--							<label>-->
...
<!--							</label>-->
							...
							<button class="btn btn-back mr-3 mt-3"><i class="fas fa-arrow-left mr-2"></i>Back</button>
						</a>
                    </div>
                    ...
                    <div class="padding-left">
                        ...
                        <div class="col-md-12 row">
							...
							<div class="col-md-6 mt-4 mb-4">
								<input id="position"  class="form-control"  placeholder="Position Name">
							</div>
							<div class="col-md-4"></div>
                        </div>
                    </div>
...
<!--                            <option value="7">Signature</option>-->
                ...
                <div  class="col-md-12" id="header_area">
                    <div class="col-md-12 row">
                        <div class="col-md-12">
                            <textarea placeholder="header description" id="header"></textarea>
                        </div>
                    </div>
                </div>
                <br>
...
<script>
            ...
            success: function (data) {
                ...
                for(var i=0;i<data.output.length;i++){
                    ...
                    if((type==1) || (type==2)) {
                        ...
                        html2+='<div class="col-md-12 row"><div class="col-md-2 offset-10"><button class="la la-trash text-danger fa-2x" onclick="delete_question('+data.output[i]['id_ats_offer_latter_question']+')" style="background-color:transparent;padding:0 10px;"></button></div></div>';
    ...
    function open_pdf(){
        //http://localhost/RbJobs/RbJobs/generatepdf?id=69
        var id_exam=$('#id_exam').val();
