						...
						<div class="account-popup">
							...
							<form id="sign_up_form" enctype="multipart/form-data">
								<div class="cfield form-group d-none job_seeker">
									<input type="text" id="fname" name="jobseeker_first_name"
										   placeholder="First Name" required/>
									<i class="la la-user"></i>
								</div>
								<div class="cfield form-group d-none job_seeker">
									<input type="text" name="jobseeker_last_name"
								...
								<div class="cfield d-none job_seeker">
									...
									<div class="row">
										<div class="col-md-12 mb-2">
											<input type="file" name="user_resume" id="upload-resume"
								...
								<img class="center-block loader-gif sign-up" id="sign-up-loader"
									 src="<?php echo base_url() ?>assets/styles/images/login-loader.gif" alt=""/>
								...
								<div class="credentials-label sign-up-success" id="sign-up-system-success">
									...
									<div class=""><p>Successfully registered. Please login with your credentials to use
											the system.</p></div>
								</div>


								<button class="d-none sign_up-common" type="submit" onclick="sign_up_user()">Sign Up
								</button>
								<!--        --><?php //echo form_close()?>
							</form>
							...
							<div class="extra-login-cus d-none sign_up-common">
								<p class="terms-conditions-notice mt-6">By Signing up, you confirm that you have read and agree with RbJobs.com's
