            ...
            <div class="row">
                ...
                <div class="col-lg-6 column">
                    <div class="contact-textinfo">
                        <h3>Jobenvoy Office</h3>
                        <ul>
                            <li><i class="la la-map-marker"></i><span>Level 06, East Tower, World Trade Center, Colombo 01</span></li>
                            <li><i class="la la-phone"></i><span><a href="tel:+94112390590">Call Us : +94 11 2 390590</a></span></li>
                            <!--                            <li><i class="la la-fax"></i><span>Fax : 0934 343 343</span></li>-->
                            <li><i class="la la-envelope-o"></i><span><a href="mailto:info@jobenvoy.com">Email : info@jobenvoy.com</a></span></li>
                        </ul>
...
<script type="text/javascript">
	...
	// marker.bindPopup("<b>Jobenvoy Location</b>").openPopup();
