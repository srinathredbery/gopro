...
<!--                                                <span>-->
<!--                                                    --><?php
//                                                    //                                                    echo !empty($post['emp_first_name']) ?  $post['emp_first_name'] : 'EMP ID: '.$post['job_post_made_by']
//                                                    if(!empty($post['emp_first_name']))
//                                                        echo $post['emp_first_name'];
//                                                    elseif ($_SESSION['company_id'] === $post['job_post_made_by'])
//                                                        echo 'Admin';
//                                                    else
//                                                        echo 'EMP ID: '.$post['job_post_made_by'].$_SESSION['company_id'];
//
//                                                    ?>
<!--                                                </span>-->
<!--                                            </td>-->
...
<!--                                                    <input type="checkbox" name="on-off-switch" onchange="job_post_status_switch(this)" id="--><?php //echo isset($post['job_post_id']) ? $post['job_post_id'] : ''?><!--" tabindex="1"-->
<!--                                                        --><?php
//                                                        if(isset($post['post_status']) && $post['post_status'])
//                                                            echo 'checked';
//                                                        ?>
<!--                                                    >-->
<!--                                                    <label for="--><?php //echo isset($post['job_post_id']) ? $post['job_post_id'] : ''?><!--">-->
<!---->
<!--                                                    </label>-->
