                                ...
                                if (isset($user_groups) && !empty($user_groups)){
                                    foreach ($user_groups as $user_group){
                                        ...
                                        <tr data-r-id="<?php echo !empty($user_group['id']) ? $user_group['id']: '' ?>">
                                            ...
                                            <td title="Assigned users">
                                                <span class="applied-field"><?php echo !empty($user_group['users_count']) ? $user_group['users_count'] : ($user_group['users_count'] == '0' ? '0' : '') ?></span>
                                            </td>
											<td>
                                                <ul class="action_job">
                                                    <li><span>Privileges</span><a class="btn-edit-user-access" title=""><i class="la la-sliders"></i></a></li>
                                                    <li onclick="delete_user_group(this)"><span>Delete</span><a class="btn-del del-user" data-r-id="<?php echo !empty($user_group['id']) ? $user_group['id']: '' ?>" title=""><i class="la la-trash-o" data-r-id="<?php echo !empty($user_group['id']) ? $user_group['id']: '' ?>"> </i></a></li>
                                                </ul>
                                            </td>
                                        </tr>
                                        <?php
												...
												<div class="<?php echo $level ?>">
													<div class="item-checkbox">
														<input type="checkbox" name="access_func[]"
															   class="filter-input route-child <?php echo !empty($func['route_id']) ? 'rou-'.$func['route_id'] : ''?>"
															   value="<?php echo !empty($func['route_id']) ? $func['route_id'] : ''?>"
															   id="child-<?php echo !empty($func['route_id']) ? $func['route_id'] : ''?>"
															   data-parent-id = "<?php echo !empty($main_func['route_id']) ? $main_func['route_id'] : ''?>"
														>
														<label class="filter-label" for="child-<?php echo !empty($func['route_id']) ? $func['route_id'] : ''?>">
