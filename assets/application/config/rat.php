...
$config['session_user_type'] = 'user_type'; // You can tell the library to take the user id from a session variable
$config['table_name'] = 'audit_log'; // If you prefer to name the table other than "rat" you can set it here...
