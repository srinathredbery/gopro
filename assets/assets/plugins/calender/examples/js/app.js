...
function cre_cal(window, Calendar) {
	...
	cal.on({
		...
		'beforeCreateSchedule': function(e) {
			...
			let stime = moment(e.start._date).format('YYYY-MM-DDThh:mm');
			let etime = moment(e.end._date).format('YYYY-MM-DDThh:mm');
			$('#interview_date').val(moment(e.start._date).format(moment.HTML5_FMT.DATE));
			$('#interview_start_time').val(moment(e.start._date).format(moment.HTML5_FMT.TIME));
			$('#interview_end_time').val(moment(e.end._date).format(moment.HTML5_FMT.TIME));
			// saveNewSchedule(e);
		},
	...
	function setSchedules() {
		...
		// 		category: 'time',
		// 		dueDateClass: '',
		// 		start: '2019-06-18T15:30:00+09:00',
		// 		end: '2019-06-18T16:30:00+09:00',
		// 		// color: '#000',
		// 		bgColor: '#ddd',
		// 		dragBgColor: '#ddd',
		// 		borderColor: '#ddd',
		...
		// 		category: 'time',
		// 		dueDateClass: '',
		// 		start: '2019-06-18T16:30:00+09:00',
		// 		end: '2019-06-18T17:30:00+09:00'
		// 	}
		// ]);
		cal.clear();
	...
	function get_schedules(){
		$.ajax({
			type: 'GET',
			dataType: 'JSON',
			url: base_url + 'employer/interview/get_all_schedules',
			// data: fdata,
			cache: false,
			contentType: false,
			processData: false,
