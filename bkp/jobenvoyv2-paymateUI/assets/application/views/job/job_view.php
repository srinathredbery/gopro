                            ...
                            <div class="row">
                                ...
                                <div class="mr-3">
                                    <a href="https://twitter.com/share?ref_src=twsrc%5Etfw" class="twitter-share-button"
                                       data-text="" data-via="jobenvoy" data-hashtags="jobs" data-related=""
                                ...
                                <div class="mr-2">
                                    <a class="share-whatsapp " target="_blank"
                                       href='https://api.whatsapp.com/send?text=Here is a job that might be interesting for you from Jobenvoy: %0D%0A*<?php echo isset($page_title)? $page_title : " ";?>* %0D%0A <?php echo $page_url; ?>' data-action="share/whatsapp/share"><i class="fab fa-whatsapp"></i> Send</a>
                                </div>
                            </div>
                        </div>
                    </div>
