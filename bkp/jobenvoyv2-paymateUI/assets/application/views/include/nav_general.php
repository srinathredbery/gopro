            ...
            <div class="container">
                <div class="logo">
                    <a href="<?php echo base_url() ?>" title="">
                        <img class="hidesticky cus-logo-sticky"
                             src="<?php echo base_url() ?>assets/styles/images/logo-half-white.png" alt=""/>
                        <img class="showsticky cus-logo-sticky"
                             src="<?php echo base_url() ?>assets/styles/images/logo-regular.png" alt=""/></a>
                    <span class="beta-tag"></span>
                </div><!-- Logo -->
                <div class="btn-extars">
