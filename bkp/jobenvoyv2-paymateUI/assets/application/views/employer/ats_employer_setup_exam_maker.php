...
<!--                            <div class="col-md-4">-->
                            &nbsp;
                                <a onclick="exam_next()" class="btn-warning btn-sm" id="next" style="color: white;">Next</a>
<!--                            </div>-->
                            &nbsp;
                        ...
                        <div class="manage-jobs-sec">
                            <div class="col-md-12"><label class="text-danger">Marks :</label><label class="text-danger" id="total_mark"></label><label class="text-danger">/100</label></div>
                        </div>
    ...
    $('#next').on('click',function () {
     ...
     function save_question(){
        ...
        if(id_exam!="") {
            ...
            Swal.fire(
                    'Can not Update',
                    'Please check Question & marks feilds',
                    'warning'
            )
        }
...
if(data.output[i]['isCorrect'] !="false"){
    ...
    checked='';
                            ...
                            typeModal='<div class="level-1-layer">';
                            typeModal+='<div class="item-radio">';
                            typeModal+='<input type="radio" id="par-'+data.output[i]['id_ats_exam_answer']+'" name="acces-'+data.output[i]['id_ats_exam_question']+'" value="1" class="" '+checked+'>';
                            typeModal+='<label class="filter-label" for="par-'+data.output[i]['id_ats_exam_answer']+'">';
                        ...
                        if((type==1) || (type==2) ) {
                            ...
                            if (Question != data.output[i]['id_ats_exam_question']) {
                                ...
                                if(Question==0) {
                                    ...
                                    html2+='<div class="col-md-12 row"><div class="col-md-4"><label class="text-danger">Marks : '+mark+'</label></div><div class="col-md-4 offset-4">' +
                                            '<button class="la la-edit text-danger fa-2x" onclick="edit_question('+data.output[i]['id_ats_exam_question']+')" style="background-color:transparent;padding:0 10px;"></button>' +
                                            '<button class="la la-trash text-danger fa-2x" onclick="delete_question('+data.output[i]['id_ats_exam_question']+')" style="background-color:transparent;padding:0 10px;"></button>' +
                                            '</div></div>';
                            ...
                            html2+='<div class="col-md-12 row"><div class="col-md-4"><label class="text-danger">Marks : '+mark+'</label></div><div class="col-md-4 offset-4">' +
                                    '<button class="la la-edit text-danger fa-2x" onclick="edit_question('+q_id+')" style="background-color:transparent;padding:0 10px;"></button>' +
                                    '<button class="la la-trash text-danger fa-2x" onclick="delete_question('+q_id+')" style="background-color:transparent;padding:0 10px;"></button>' +
                                    '</div></div>';
