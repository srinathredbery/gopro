                            ...
                            <table class="datatable-init table1">
                                <thead>
                                    <tr>
                                        ...
                                        <td class="px-0">Contact Number</td>
                                    ...
                                    if (isset($active_job_posts) && !empty($active_job_posts)) {
                                        ...
                                        foreach ($active_job_posts as $active_post) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="status">
                                                        <?php echo $active_post['contact_number']; ?>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span class="status">
                                                        <a class="la la-pencil text-info fa-2x" data-toggle="modal" data-target="#myModal" onclick="editInterviwer('<?php echo $active_post['idinterviewer_list'] ?>','<?php echo $active_post['name'] ?>','<?php echo $active_post['position'] ?>','<?php echo $active_post['contact_number'] ?>');"></a>&nbsp;
...
<script>
    ...
    function save_interviewer() {
        ...
        if(name_interviewer==""){
            Swal.fire(
                    'Required!',
                    'Interviewer Name field Required',
                    'warning'
            );
