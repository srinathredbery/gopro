...
//                    $rec_id = $rec_data_received['rec_id'];
    ...
    function upload_resume(){
        ...
        else
        {
            ...
            $res = $this->resume_model->update_resume_info($resume_id, array('resume_attachment' => $upload_status['file_name']));
    ...
    function delete_resume_file_attachment(){
        $resume_id = $this->input->post('r_id');
        try {
            $res_info = $this->resume_model->get_resume_info(array('resume_id'=>$resume_id));
